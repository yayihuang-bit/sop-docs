...
- [包鑽 Slack 開發群](https://yiletechnology.slack.com/archives/C09QQCLMCRZ)
...
3. 在商品對應的分頁，寫上[商品介紹](https://docs.google.com/spreadsheets/d/1v2pGobWxheuHk7v-mSV8BjBXJutBcsPo3YkSRkquaig/edit?gid=1786736022#gid=1786736022)
    ...
    <img src="../images/包鑽/螢幕擷取畫面 2026-08-18 171631.png" alt="包鑽商品介紹頁面示意圖" style="max-width:1000px;width:100%;">

4. 需於預計上架商品日前，於[包鑽正式站後台](https://backstage.808bonus.com.tw/auth/sign-in?returnTo=%2Fdashboard)「產品管理」設定上架資料，並填寫商品的描述與介紹

    <img src="../images/包鑽/上架商品.png" alt="產品管理上架示意圖" style="max-width:1000px;width:100%;">
...
<img src="../images/包鑽/訂單.png" alt="訂單管理示意圖" style="max-width:1000px;width:100%;">

1. 上架後，若有玩家訂購，則確定是否有貨
2. 若沒有貨，則要補貨（見下方「訂單採購流程」）
3. 有貨的話，則調整玩家狀態，準備出貨
4. 完成後，將狀態調整為「已出貨」

## 訂單採購流程

過程中採購需要打單，[平台帳號密碼、發票種類、採購流程彙整](https://docs.google.com/spreadsheets/d/1flARXhlZSyNnKtrLMahw518Oz0xpIBEyP2mzTU4jv9M/edit?gid=48491988#gid=48491988)
