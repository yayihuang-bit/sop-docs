...
遊戲／活動 info／官網表格區更新時，判斷是否要跟著調整文案。整篇文件依情境分兩大類：**新增全新INFO** 與 **修改現有INFO**。
...
1. 請參照記事本，建立成員清單，方便行銷美術們需要溝通時好找人
...
2. 於群組對話中提供 [HELP 雲端資料夾]({{ links.game_website_info_folder }})中的文案連結

3. 完成後，行銷美術會於群組通知（例如：「官網 HELP 已完成，賠率表部分也已修正，再麻煩協助確認」）
...
不須建立記事本，直接於群組對話中提供 [HELP 雲端資料夾]({{ links.game_website_info_folder }})中的文案連結，並附上需求的說明及預計需更新的時間

調整參考範例：

> @小藍 德州撲克與奧馬哈撲克 官網 [VIP 層級表格](https://drive.google.com/drive/folders/1ROZ83xDibrOgM8Yd6aJC56bnEq3O4TEq) 有遺漏，已補上再請協助更新　謝謝
