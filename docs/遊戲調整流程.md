...
1. [官網-遊戲說明]({{ links.game_website_info_folder }})、[VIP 層級表格](https://drive.google.com/drive/folders/1ROZ83xDibrOgM8Yd6aJC56bnEq3O4TEq)（行銷美術負責），完成後於 LINE 群「包你發-遊戲Help討論群組」通知

2. APP 規格：[遊戲導引](https://drive.google.com/drive/folders/1cB2Mlsiah27ltEGx7JWixmILmHL0aOCS)、[會員系統](https://drive.google.com/drive/folders/1vLlPlHJ1SKfMc7Q_4byhF2nqDNOluKEe)（美術、RD、QA、維運負責），完成後於 Slack「包你發-營運組」「包你發-維護or更新」通知
...
1. 釋出關閉資訊，企劃同步給各端點[準備遊戲下架文案](https://drive.google.com/file/d/1BOOBDeWv23Ea2OqQB3_NDpNhfC0Uaoat/view?ths=true)（官網／公告都要上）——維運、行銷窗口巧妙分工：一邊釋出關閉資訊，一邊[釋出關閉資訊（哪款遊戲）](https://online808.com/news/3240)並請行銷確認產包、廣告預計下架時間
